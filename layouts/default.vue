<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="relative flex">
      <div
        class="bg-white border-r-2 sidebra transition-[width] duration-150 ease-in-out absolute left-0 xl:sticky xl:left-0 overflow-hidden"
        :class="isCollapse ? 'w-0' : ' w-96'"
      >
        <ul class="flex flex-col h-[90vh] overflow-y-scroll">
